# -*- coding: utf-8 -*-
"""
光伏支架线模生成器 V1.2.29 — 界面骨架（MVP M1，2026-08-12 第三十二版）

运行方式：
    python pv_support_gui.py

V1.2.29 改动（槽钢名修正 + 方位角实测微调）：
    1. 槽钢型号名改为 3D3S 方括号表示法：槽8→[8、槽10→[10
       （依据新导出的普通槽钢.dat，A=1024 与国标一致），
       消除"参数错误"警告；
...
MEMBER_ROLES = [
    ("立柱", "槽钢",   "槽8",                "Q235B"),
    ("斜梁", "C型钢",  "C140X50X20X2.5",     "Q355B"),
    ("檩条", "C型钢",  "C100X50X15X2.5",     "Q235B"),
    ("斜撑", "角钢",   "L50×5",              "Q235B"),
    ("檩托", "角钢",   "L40×4",              "Q235B"),
    ("抱箍", "自定义", "自定义",             "Q235B"),
...
class PvSupportApp:
    def __init__(self, root):
        ...
        self.set_status("就绪 V1.2.29：槽钢名[8修正；立柱180°檩条110°方位角校准")
