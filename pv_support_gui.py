# -*- coding: utf-8 -*-
"""
光伏支架线模生成器 V1.2.31 — 界面骨架（MVP M1，2026-08-12 第三十四版）

运行方式：
    python pv_support_gui.py

V1.2.31 改动（檩条方位角）：
    1. 檩条绕1轴转角 110°→160°（=180°−倾角20°）；
       立柱 180°、斜梁 0°、斜撑 90° 保持。
...
class PvSupportApp:
    def __init__(self, root):
        ...
        self.set_status("就绪 V1.2.31：檩条方位角160°（180−20），4根统一")
